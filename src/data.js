export const firstPicture = {
  ...
  authorDescription: 'Margaret Sarah Carpenter (1793–1872) fue una pintora británica conocida por sus retratos. Fue una artista destacada de su época, exponiendo en la Royal Academy y otras instituciones importantes. Su trabajo captura la esencia de sus sujetos con un realismo y sensibilidad notables.'
}
...
export const secondPicture = {
  ...
  authorDescription: 'J. Howard Miller fue un artista gráfico estadounidense. Es mejor conocido por su cartel de la Segunda Guerra Mundial "We Can Do It!", destinado a aumentar la moral de los trabajadores. La pieza se ha convertido en un ícono de la cultura popular y un símbolo del empoderamiento femenino.'
}
...
export const fourthPicture = {
  ...
  authorDescription: 'Frida Kahlo (1907–1954) fue una pintora mexicana conocida por sus autorretratos llenos de color y simbolismo. A través de su arte, exploró temas como la identidad, la poscolonialidad, el género, la clase y la raza en la sociedad mexicana. Kahlo es celebrada como una figura emblemática del arte nacional e internacional.'
}
